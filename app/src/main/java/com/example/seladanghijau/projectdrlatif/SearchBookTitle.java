...
public class SearchBookTitle extends ActionBarActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_book_title);
        ...
        lvBookList.setOnItemClickListener(SearchBookTitle.this); // set onclicklistener utk setiap item dlm ListView
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_search_book_title, menu);
        return true;
    }
    ...
    private class GetBook extends AsyncTask<Void, Void, Boolean> {
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SearchBookTitle.this);
        ...
        protected Boolean doInBackground(Void... params) {
            inBookTitle = txtSearchBook.getText().toString();
            listTajukBuku.clear();
            ...
            try {
                ...
                postData.add(new BasicNameValuePair("inSearchType", "title"));
        ...
        protected void onPostExecute(Boolean result) {
            ...
            listTajukBukuAdapter = new ArrayAdapter<>(SearchBookTitle.this, R.layout.menulist_layout, listTajukBuku);
